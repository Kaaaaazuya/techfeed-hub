...
export class TechfeedStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const rssLambda = new lambda.Function(this, 'RssFetcherLambda', {
      runtime: lambda.Runtime.JAVA_21,
      handler: 'rssfetcher.lambda.RssLambdaHandler',
      code: lambda.Code.fromInline('placeholder'), // テスト用のプレースホルダー
